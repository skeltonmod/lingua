...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_peerjs: string;
	export const RUSTROVER_VM_OPTIONS: string;
	export const DEVECOSTUDIO_VM_OPTIONS: string;
	export const PATH: string;
	export const npm_config_argv: string;
	export const npm_package_dependencies_vite_plugin_cross_origin_isolation: string;
	...
	export const npm_package_dependencies__types_peerjs: string;
	...
	export const npm_package_dependencies__sqlite_org_sqlite_wasm: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_peerjs: string;
		RUSTROVER_VM_OPTIONS: string;
		DEVECOSTUDIO_VM_OPTIONS: string;
		PATH: string;
		npm_config_argv: string;
		npm_package_dependencies_vite_plugin_cross_origin_isolation: string;
		_: string;
		...
		npm_package_dependencies__types_peerjs: string;
		...
		npm_package_dependencies__sqlite_org_sqlite_wasm: string;
